        ...
        <div class="w-full md:w-8/12 lg:w-6/12">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 space-y-4">
                <div class="flex justify-between items-center">
                    <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Agregar Nuevo Paciente</h2>
                    <a href="{{ route('pacientes.index') }}" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md shadow-md flex items-center"><i class="bi bi-arrow-left mr-1"></i> Volver</a>
                            ...
                            <form action="{{ route('pacientes.store') }}" method="post" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500 placeholder-gray-500 @error('nombre') border-red-500 @enderror" id="nombre" name="nombre" value="{{ old('nombre') }}" placeholder="Ingrese el nombre del paciente" required>
                                    @error('nombre')
                                ...
                                <div>
                                    ...
                                    <input type="text" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500 placeholder-gray-500 @error('apellido') border-red-500 @enderror" id="apellido" name="apellido" value="{{ old('apellido') }}" placeholder="Ingrese el apellido del paciente" required>
                                    @error('apellido')
                                        <span class="text-red-500 mt-1">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500 placeholder-gray-500 @error('email') border-red-500 @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Ingrese el email del paciente" required>
                                    @error('email')
                                        <span class="text-red-500 mt-1">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500 placeholder-gray-500 @error('telefono') border-red-500 @enderror" id="telefono" name="telefono" value="{{ old('telefono') }}" placeholder="Ingrese el teléfono del paciente" required>
                                    @error('telefono')
                                        <span class="text-red-500 mt-1">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500 placeholder-gray-500 @error('alergias') border-red-500 @enderror" id="alergias" name="alergias" placeholder="Ingrese las alergias del paciente">{{ old('alergias') }}</textarea>
                                    @error('alergias')
                                        <span class="text-red-500 mt-1">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-blue-500 placeholder-gray-500 @error('enfermedades') border-red-500 @enderror" id="enfermedades" name="enfermedades" placeholder="Ingrese las enfermedades del paciente">{{ old('enfermedades') }}</textarea>
                                    @error('enfermedades')
                                        <span class="text-red-500 mt-1">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    <input type="submit" class="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md shadow-md cursor-pointer" value="Agregar Paciente">
                                </div>
                            </form>
                        </div>
                    </div>
